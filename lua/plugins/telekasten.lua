...
return {
  ...
  opts = {
    ...
    dailies = vim.fn.expand("~/vaults/personal/daily-notes"),
    templates = vim.fn.expand("~/vaults/personal/templates"),
    -- TODO: Create templates ...
    template_new_note = vim.fn.expand("~/vaults/personal/templates/new-note-template.md"),
    template_new_daily = vim.fn.expand("~/vaults/personal/templates/daily-note-template.md"),
    image_subdir = "media",
